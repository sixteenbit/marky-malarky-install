...
# Install Retrogame
echo "Select option 1 for Retrogame"
...
echo "After rebooting, run the following script again - curl -sS https://raw.githubusercontent.com/adafruit/Raspberry-Pi-Installer-Scripts/master/i2samp.sh | bash"
